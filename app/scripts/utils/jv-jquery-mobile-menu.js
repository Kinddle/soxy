...
(function ($) {
  ...
  $.fn.jvmobilemenu = function (options) {
    ...
    settings.theMenu.css({
      ...
      display: 'none',
      height: '100%'
    }).addClass('hamburger-mobile-menu').wrapInner('<div class="mobile-menu-inner"></div>');
    ...
    var hamburger = $('.hamburger-mobile-menu'),
    ...
    theMarginLeft = settings.mobileMenuWidth;
    ...
    function menuOpen() {
      ...
      // From http://stackoverflow.com/a/14244680
      // var setScrollable = '.hamburger-mobile-menu',
      // bodySelect = $('body');
      //
